...
const americanExpressLogo = require("../assets/american-express-logo.png");
const masterCardLogo = require("../assets/master-card-logo.png");
        ...
        <div className="modal-dialog">
          <div className="modal-content">
            ...
            <div className="modal-body">
              <p>
                <img src={visaLogo} alt="visa" width={25} height={25} />
                <img
                  className="mx-1"
                  src={masterCardLogo}
                  alt="mastercard"
